...
public class IniciarSesion extends javax.swing.JFrame {
    ...
    private void botonEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEntrarActionPerformed
        //jonatanalonzoart@gmail.com / AlonzoDesing
        
        //valido que no esta vacio las cajas
        if(cajaContraseña.getText().isEmpty() && cajaUsuario.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(null, "Ingrese su nombre de usuario y contraseña ");
        }
        else{
            
            //llamo la clase conexion (propiedad conectar)
            Conexion conectar = new Conexion();
            Statement st = conectar.Conectar();
            
            //con la conexion exitosa hago un try
            try{

                //EJECUTO UNA LECTURA A LA BASE DE DATOS
            ResultSet rs = st.executeQuery("select * from usuariosmodulos Where Usuario='"+cajaUsuario.getText()+"'and Contraseña='"+cajaContraseña.getText()+"'");
            rs.last();
            int encontrado = rs.getRow();

            //SI ENCUENTRA ME RETORNA UN 1 Y ABRE
            if (encontrado == 1)
            {
                JOptionPane.showMessageDialog(null, "BIENVENIDO(A) \n" +cajaUsuario.getText(),"Mensaje",JOptionPane.INFORMATION_MESSAGE);
                Menu rp = new  Menu();
                rp.setVisible(true);
                hide();
            }
